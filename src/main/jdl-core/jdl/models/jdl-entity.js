...
const { upperFirst, lowerFirst, pluralize, kebabCase } = require('../utils/string-utils');
...
module.exports = class JDLEntity {
  constructor(args) {
    ...
    this.kebabCase = kebabCase(this.name);
    this.kebabCasePlural = kebabCase(this.classNamePlural);
